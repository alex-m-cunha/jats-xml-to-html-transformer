...
PDF_DIR="$ROOT/transformation-template/assets/pdf"
PDF_SUFFIX="_PDF.pdf"
...
if [[ -d "$XML_DIR/$ARTICLE_IMG_SUB" ]]; then
  mkdir -p "$OUT_DIR/$ARTICLE_IMG_SUB"
  rsync -a "$XML_DIR/$ARTICLE_IMG_SUB"/ "$OUT_DIR/$ARTICLE_IMG_SUB/"
fi
