...
<xsl:stylesheet version="1.0"
  ...
  <xsl:param name="pdf-href"/> <!-- select="'..input/pdf/15dgxd54_PDF.pdf'"/> -->              
  <xsl:param name="article-img"/> <!-- select="'../input/article-img/15dgxd54_g001.png'"/> -->
  ...
  <xsl:template match="/">
    ...
    <html lang="en">
      <head>
        ...
        <!-- CSS -->
        <!-- <link rel="stylesheet" href="{$assets-path}stylesheets/base.css" /> 
        <link rel="stylesheet" href="{$assets-path}stylesheets/layout.css" />
        <link rel="stylesheet" href="{$assets-path}stylesheets/popovers.css" />
        <link rel="stylesheet" href="{$assets-path}stylesheets/publisher-header.css" />
        <link rel="stylesheet" href="{$assets-path}stylesheets/masthead.css" />
        <link rel="stylesheet" href="{$assets-path}stylesheets/sidebar.css" />
        <link rel="stylesheet" href="{$assets-path}stylesheets/toc.css" />
        <link rel="stylesheet" href="{$assets-path}stylesheets/footer.css" />
        <link rel="stylesheet" href="{$assets-path}stylesheets/fonts.css" />
        <link rel="stylesheet" href="{$assets-path}stylesheets/assets.css" /> -->
        <link rel="stylesheet" href="{$assets-path}stylesheets/css.css" />
      </head>
      ...
      <body>
        ...
        <!-- <script src="{$assets-path}stylesheets/popovers.js"></script>
        <script src="{$assets-path}stylesheets/tab-switching-functionality.js" defer="defer"></script>
        <script src="{$assets-path}stylesheets/toc.js" defer="defer"></script>
        <script src="{$assets-path}stylesheets/lightbox.js" defer="defer"></script>
             
        <script src="{$assets-path}stylesheets/javascript.js" defer="defer"></script>
      </body>
    </html>
  </xsl:template>
