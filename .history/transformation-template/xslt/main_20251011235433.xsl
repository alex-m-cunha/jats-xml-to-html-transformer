...
<xsl:stylesheet version="1.0"
  ...
  <!-- ===== Parameters ===== -->
  <xsl:param name="assets-path" select="'/assets/stylesheets/'" />           <!-- CSS/JS relative folder -->
  ...
  <xsl:template match="/">
    ...
    <html lang="en">
      <head>
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="{$assets-path}base.css" />
        <link rel="stylesheet" href="{$assets-path}layout.css" />
        <link rel="stylesheet" href="{$assets-path}popovers.css" />
        <link rel="stylesheet" href="{$assets-path}publisher-header.css" />
        <link rel="stylesheet" href="{$assets-path}masthead.css" />
        <link rel="stylesheet" href="{$assets-path}sidebar.css" />
        <link rel="stylesheet" href="{$assets-path}toc.css" />
        <link rel="stylesheet" href="{$assets-path}footer.css" />
        <link rel="stylesheet" href="{$assets-path}fonts.css" />
        <link rel="stylesheet" href="{$assets-path}assets.css" />
      </head>
      ...
      <body>
        ...
        <script src="{$assets-path}popovers.js"></script>
        <script src="{$assets-path}tab-switching-functionality.js" defer="defer"></script>
        <script src="{$assets-path}toc.js" defer="defer"></script>
