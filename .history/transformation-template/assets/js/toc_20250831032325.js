...
(function () {
  ...
  document.addEventListener('click', (e) => {
    ...
    // Fast custom scroll animation (300ms instead of default ~1000ms)
    const start = window.scrollY;
    const duration = 300; // milliseconds - adjust this to make it faster/slower
    ...
    function animateScroll(currentTime) {
      ...
      window.scrollTo(0, start + (top - start) * easeProgress);
