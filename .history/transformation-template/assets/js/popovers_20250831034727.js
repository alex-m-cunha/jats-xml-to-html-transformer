...
(function () {
  ...
  function setOpen(trigger, pop, open) {
    ...
    if (open) {
      ...
      // Skip focus management for author popovers to prevent jumping
      if (!pop.classList.contains('author-popover')) {
      ...
      // Store currently focused element to prevent focus jumping
      ...
      // Keep focus stable if it was on the trigger
