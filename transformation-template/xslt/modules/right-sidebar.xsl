        ...
        <div>
            ...
            <a class="btn primary"> 
                ...
                <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.75 11.7042V14.7042C15.75 15.102 15.592 15.4835 15.3107 15.7649C15.0294 16.0462 14.6478 16.2042 14.25 16.2042H3.75C3.35218 16.2042 2.97064 16.0462 2.68934 15.7649C2.40804 15.4835 2.25 15.102 2.25 14.7042V11.7042" stroke="#585754" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M5.25 7.95419L9 11.7042L12.75 7.95419" stroke="#585754" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M9 11.7042V2.70419" stroke="#585754" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <span>
                    <xsl:choose>
        ...
        <section class="accordion-wrapper" aria-label="More Article Metadata">
            ...
            <details class="accordion">
                ...
                <p class="cc-by-nc-icon">
                    <svg title="Creative Commons BY-NC 4.0" width="80" height="24" viewBox="0 0 80 24" fill="none" xmlns="http://www.w3.org/2000/svg">
