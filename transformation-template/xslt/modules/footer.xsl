            ...
            <div class="footer-wrap" role="contentinfo">
                ...
                <div class="footer-top">
                    ...
                    <div class="footer-left">
                                ...
                                <h2 class="journal-name">
                                    <xsl:choose>
                                        <xsl:when test="journal-title-group/journal-title">
                                            <xsl:value-of
                                                select="normalize-space(journal-title-group/journal-title)" />
                                        </xsl:when>
                        ...
                        <div class="publisher-block">
                            ...
                            <address class="publisher-address"> [Street Address], [Floor/Suite if
                                any], [City],<br /> [State], [ZIP Code], [Country] </address>
                        </div>
                    </div>
                    ...
                    <div class="footer-right">
                        ...
                        <a class="hosting-org" href="https://pkp.sfu.ca/" target="_blank"
                            rel="noopener"> Public<br />Knowledge<br />Project </a>
                    </div>
                </div>
                ...
                <div class="footer-bottom">
                    ...
                    <ul class="cc-icons" aria-label="License icons">
                        <li>
                            <img src="{$assets-path}img/cc.svg" alt="Creative Commons" width="20"
                                height="20" />
                        </li>
                        <li>
                            <img src="{$assets-path}img/cc-by.svg" alt="Attribution (BY)" width="20"
                                height="20" />
                        </li>
                        <li>
                            <img src="{$assets-path}img/cc-nc.svg" alt="NonCommercial (NC)"
                                width="20" height="20" />
                        </li>
                    </ul>

                    <!-- License text -->
                    <p class="license-line"> Content on this website is licensed under a Creative
